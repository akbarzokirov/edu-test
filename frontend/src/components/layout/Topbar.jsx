        ...
        <div className="hidden md:flex items-center gap-2 flex-1 max-w-md">
          <div className="relative w-full">
            ...
            <input
              ...
              className="w-full h-10 pl-10 pr-4 rounded-xl bg-white border border-ink-200 text-sm placeholder:text-ink-400 focus:border-brand-500 focus:ring-2 focus:ring-brand-100 focus:outline-none transition-colors"
            />
          </div>
        </div>
        <div className="ml-auto flex items-center gap-1.5">
          <div ref={notifRef} className="relative">
            <button
              ...
              className="relative p-2 rounded-xl text-ink-700 hover:bg-ink-100"
            >
            ...
            {notifOpen && (
              <div className="absolute right-0 mt-2 w-80 bg-white rounded-2xl shadow-pop border border-ink-100 overflow-hidden animate-slide-up">
                ...
                <div className="max-h-80 overflow-y-auto divide-y divide-ink-100">
                  {[
                    {
                      title: "Yangi test yakunlandi",
                      desc: "Algebra asoslari — 24 topshiruvchi",
                      time: "15 daqiqa oldin",
                    },
                    {
                      title: "Deadline yaqinlashmoqda",
                      desc: "Mexanika — 3 kun qoldi",
                      time: "2 soat oldin",
                    },
                    {
                      title: "AI test yaratildi",
                      desc: "Organik kimyo — 22 savol",
                      time: "5 soat oldin",
                    },
                  ].map((n, i) => (
                    <div
          ...
          <div ref={menuRef} className="relative">
            <button
              ...
              className={cn(
                "flex items-center gap-2 pl-1 pr-2 py-1 rounded-xl hover:bg-ink-100 transition-colors",
                menuOpen && "bg-ink-100",
              )}
            >
              ...
              <div className="absolute right-0 mt-2 w-56 bg-white rounded-2xl shadow-pop border border-ink-100 overflow-hidden animate-slide-up">
                ...
                <div className="p-1.5">
                  <button
                    ...
                    className="w-full flex items-center gap-2.5 px-2.5 py-2 rounded-lg text-sm text-ink-700 hover:bg-ink-100"
                  >
                ...
                <div className="p-1.5 border-t border-ink-100">
                  <button
                    ...
                    className="w-full flex items-center gap-2.5 px-2.5 py-2 rounded-lg text-sm text-danger-600 hover:bg-danger-50"
                  >
