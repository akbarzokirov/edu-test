    ...
    <div>
              ...
              <AreaChart data={mockChartData}>
                ...
                <Tooltip
                  contentStyle={{
                    ...
                    fontSize: 12,
                    padding: "8px 12px",
                    boxShadow: "0 10px 40px -12px rgba(15,23,42,0.4)",
                  }}
                />
                <Area
                  type="monotone"
      ...
      <div className="mt-6 grid grid-cols-1 sm:grid-cols-3 gap-3">
        <QuickAction
          ...
          description="Yangi o'qituvchi yarating va guruhlarga biriktiring"
        />
        <QuickAction
          to="/admin/groups"
          icon={Users}
          label="Guruh yaratish"
          description="O'quvchilar uchun yangi sinf-guruh oching"
        />
        <QuickAction
          to="/admin/semesters"
          icon={BookOpenCheck}
          label="Semestrlarni ko'rish"
          description="Faol semestrlar va ularning holati"
        />
      </div>
    </div>
  );
